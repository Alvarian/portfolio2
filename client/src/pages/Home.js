    ...
    <div>
		...
		<div className="amatic" id="scrolltop">
		  ...
		  <div style={{justifyContent: "center", display: "flex", flexDirection: "column", alignItems: "center", width: "100%"}}>
			<div style={{width: "100%", zIndex: 5}}>
			  <div className="float" style={{backgroundColor: "wheat", display: "flex", justifyContent: "spaceAround", width: "100%"}}>
				...
				<div className="down" style={{display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", backgroundColor: "white", flex: 1, minWidth: "150px"}}>
				  <p><span className="anchor" id="btn" style={{fontSize: "16pt", cursor: "pointer", border: "solid 1px black", backgroundColor: "white"}}>View my resume</span></p>
				...
				<div id="modal" style={{display: "none", height: "100vh"}}>
					<div className="modal-content" style={{display: "flex", justifyContent: "center", maxWidth: "400px", minWidth: "310px", flexDirection: "column", borderRadius: "5px", minHeight: "560px"}}>
						<span className="clsbtn orbi" style={{cursor: "pointer"}}>X</span>
						<div style={{width: "100%", display: "flex", justifyContent: "center"}}>	
							<div className="resume"></div>
						</div>
						<div className="downRes">
							<a className="anchor" style={{color: "red"}} href="" download><i className="fas fa-file-download fa-3x"></i></a>
							<span className="tooltiptext">Download my resume as PDF!</span>
						</div>
					</div>
				</div>
			...
			<div className="float" style={{display: "flex", justifyContent: "spaceAround", padding: "70px 0px", width: "100%"}}>
			  <div className="bord">
				<h2>Commonly Used</h2>
		...
		<div style={{position: "relative"}}>
			...
			<div style={{display: "flex", justifyContent: "center", alignItems: "center", width: "100%"}}>
				<div className="footerBtns">
					...
					<a className="circle anchor scrollUp"><i className="fas fa-arrow-up"></i></a>
				</div>
			</div>
		</div>
    </div>
